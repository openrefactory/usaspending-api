...
transaction_search_load_sql_string = fr"""
    ...
    LEFT OUTER JOIN
        global_temp.transaction_fabs_temp_pipe_286 ON (transaction_normalized_temp_pipe_286.id = s.transaction_id AND transaction_normalized_temp_pipe_286.is_fpds = false)
    LEFT OUTER JOIN
